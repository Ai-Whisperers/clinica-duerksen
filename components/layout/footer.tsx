      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold">Clínica Duerksen</h3>
            <p className="text-white/70 text-sm leading-relaxed">
              Odontología de excelencia en Asunción, Paraguay.
              Más de 26 años cuidando tu sonrisa.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm text-white/70">
              ...
              <li>
                <a href={`tel:${BUSINESS.phoneRaw}`} className="flex items-center gap-2 hover:text-white transition-colors">
          ...
          <div className="space-y-4">
            ...
            <div className="text-sm text-white/70 space-y-2">
              <div className="flex items-start gap-2">
                <Clock className="w-4 h-4 mt-0.5 shrink-0 text-brand-accent" />
                <div>
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-white/50">Sábados y Domingos</p>
                  <p className="text-white/50">Cerrado</p>
                </div>
              </div>
            </div>
          </div>
