...
export const metadata: Metadata = {
  title: "Ortodoncia en Asuncion - Brackets y Alineadores",
  description: "Ortodoncia para todas las edades. Brackets metalicos, esteticos y alineadores invisibles.",
  robots: { index: false, follow: false },
};

export default function LP() {
  const waMsg = encodeURIComponent("Hola! Vi su anuncio de Ortodoncia y me gustaria mas informacion.");
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-gradient-to-br from-brand-primary to-brand-dark text-white py-20 px-4">
        <div className="max-w-2xl mx-auto text-center space-y-6">
          <h1 className="text-4xl md:text-5xl font-bold">Alinea tu sonrisa perfecta</h1>
          <p className="text-xl text-white/80">Brackets metalicos, ceramicos y alineadores invisibles. Tratamiento personalizado.</p>
