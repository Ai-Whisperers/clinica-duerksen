...
export const metadata: Metadata = {
  title: "Blanqueamiento Dental Profesional en Asuncion",
  description: "Blanqueamiento dental en 1 sesion. Resultados inmediatos y seguros.",
  robots: { index: false, follow: false },
};

export default function LP() {
  const waMsg = encodeURIComponent("Hola! Vi su anuncio de Blanqueamiento Dental y me gustaria mas informacion.");
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-gradient-to-br from-brand-primary to-brand-dark text-white py-20 px-4">
        <div className="max-w-2xl mx-auto text-center space-y-6">
          <h1 className="text-4xl md:text-5xl font-bold">Sonrisa brillante en 1 sesion</h1>
          <p className="text-xl text-white/80">Blanqueamiento laser profesional con resultados visibles inmediatos. 100% seguro.</p>
