...
export const metadata: Metadata = {
  title: "Implantes Dentales en Asuncion",
  description: "Implantes dentales de titanio con el Dr. Victor Duerksen. 26+ anos de experiencia.",
  robots: { index: false, follow: false },
};

export default function LP() {
  const waMsg = encodeURIComponent("Hola! Vi su anuncio de Implantes Dentales y me gustaria mas informacion.");
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-gradient-to-br from-brand-primary to-brand-dark text-white py-20 px-4">
        <div className="max-w-2xl mx-auto text-center space-y-6">
          <h1 className="text-4xl md:text-5xl font-bold">Recupera tu sonrisa completa</h1>
          <p className="text-xl text-white/80">Implantes de titanio de ultima generacion con garantia. Resultados naturales y permanentes.</p>
